...
HI: dict = {
    ...
    "ui": {
        ...
        "sys_viewport_caveat": "पेज लोड, लोग नहीं: सिर्फ़ हर चौड़ाई श्रेणी की एक चलती "
                               "हुई गिनती दर्ज होती है — कोई समय नहीं, कोई कुकी नहीं, "
                               "कोई आईपी पता दर्ज नहीं होता, कोई पहचान नहीं, और किसी "
                               "एक पेज लोड का कोई रिकॉर्ड नहीं। यह ब्राउज़र विंडो की चौड़ाई है, डिवाइस "
    ...
    "guide": {
        ...
        "a_privacy": "आपकी उम्र, बीमारी और आपके काम पेज के पते और आपके सेशन में रहते हैं — ये "
                     ...
                     "बताता है उसकी गिनती एक से बढ़ जाती है — हर श्रेणी के लिए बस एक "
                     "गिनती, न कोई समय, न कोई सेशन आईडी और न कुछ और।",
